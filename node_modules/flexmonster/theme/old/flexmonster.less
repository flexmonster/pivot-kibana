...
@theme-color-midlight: #ccc;//cdcdcd;
@theme-color-light: #ccc;//#ebebeb;
@theme-color-superlight: #f7f7f7;
@theme-color-supersuperlight: #fff;
...
@toolbar-icon-fill-border: @theme-color;
@toolbar-icon-fill-background: lighten(@theme-color, 30%);
...
@grid-sheet-header-border-color: @theme-color-supersuperlight;
...
@grid-table-header-color: @theme-color-dark;
...
@grid-filter-text-color: @theme-text-color-inverted;
...
@grid-selection-canvas-border: 1px solid #ccc;
@grid-auto-calculation-bar: #888;

/* ===== charts ===== */
@charts-label-font-size: 14px;
@charts-axis-font-size: 14px;
@charts-axis-text-color: @theme-text-color;
@charts-axis-title-color: @theme-text-color;
@charts-pie-label-color: @theme-text-color;
...
@ui-btn-dark-color-hover: @theme-color-dark;
...
@ui-icon-color-dark: @theme-color;
